...
_ACCOUNT_NAMES_BY_REGION: dict[str, list[tuple[str, str]]] = {
    # (phone, language) — demo seed forces English-only for readability.
    "IRQ_BAGHDAD": [
        ("+9647000000001", "en"), ("+9647000000010", "en"),
        ("+9647000000011", "en"), ("+9647000000012", "en"),
        ("+9647000000013", "en"), ("+9647000000014", "en"),
        ("+9647000000015", "en"),
    ],
    "IRQ_MOSUL": [
        ("+9647000000002", "en"), ("+9647000000020", "en"),
        ("+9647000000021", "en"), ("+9647000000022", "en"),
        ("+9647000000023", "en"),
    ],
    "SYR_ALEPPO": [
        ("+9639000000001", "en"), ("+9639000000010", "en"),
        ("+9639000000011", "en"), ("+9639000000012", "en"),
        ("+9639000000013", "en"), ("+9639000000014", "en"),
    ],
    "SYR_DAMASCUS": [
        ("+9639000000002", "en"), ("+9639000000020", "en"),
        ("+9639000000021", "en"), ("+9639000000022", "en"),
    ],
    "YEM_SANAA": [
        ("+9677000000001", "en"), ("+9677000000010", "en"),
        ("+9677000000011", "en"), ("+9677000000012", "en"),
        ("+9677000000013", "en"), ("+9677000000014", "en"),
    ],
    "LBN_BEIRUT": [
        ("+9613000000001", "en"), ("+9613000000010", "en"),
        ("+9613000000011", "en"), ("+9613000000012", "en"),
    ],
}
...
_INBOUND_BY_REGION: dict[str, list[tuple[str, str, str, str, float]]] = {
    "IRQ_BAGHDAD": [
        ("sighting", "en", "Saw a girl in a red dress near the bakery 10 minutes ago", "u0", 0.82),
        ("sighting", "en", "Young girl alone on Al-Rashid street, crying", "u1", 0.76),
        ("sighting", "en", "Saw a girl matching the description near Al-Mutanabbi street", "u2", 0.71),
        ("sighting", "en", "Girl in red dress heading toward the bridge", "u0", 0.78),
        ("question", "en", "Is the girl still missing? We hear distant voices", "u3", 0.40),
        ("ack", "en", "Searched our neighborhood, did not find her", "u4", 0.50),
        ("sighting", "en", "Someone saw her near the vegetable market 15 minutes ago", "u1", 0.72),
        ("noise", "en", "Hello", "u5", 0.10),
        ("sighting", "en", "Two witnesses say a girl in red was put in a white car near checkpoint", "u2", 0.88),
        ("sighting", "en", "Found a red dress near the river, investigating now", "u0", 0.84),
        ("ack", "en", "We are watching the checkpoint", "u3", 0.55),
        ("sighting", "en", "Girl is sitting on sidewalk near the mosque, we are comforting her", "u1", 0.91),
        # Medical alert messages
        ("question", "en", "Is there an open pharmacy with insulin?", "u4", 0.50),
        ("ack", "en", "I have insulin pens, can deliver to Al-Karkh in 30min", "u3", 0.85),
        ("sighting", "en", "Al-Rashid pharmacy has stock", "u2", 0.74),
    ],
    "IRQ_MOSUL": [
        ("sighting", "en", "Elderly man standing alone near the city gate", "p0", 0.69),
        ("sighting", "en", "Elderly man wandering near the old market, looks confused", "p1", 0.74),
        ("sighting", "en", "I think I saw him entering the old mosque", "p2", 0.62),
        ("question", "en", "What is his name and who is looking for him?", "p3", 0.40),
        ("ack", "en", "We informed the imam, he will keep watch", "p2", 0.55),
        ("sighting", "en", "Found an elderly man sitting at the cafe, I think it is him", "p1", 0.81),
    ],
    "SYR_ALEPPO": [
        ("sighting", "en", "Bustan al-Qasr building collapsed, we hear screams from under the rubble", "q0", 0.93),
        ("sighting", "en", "Need excavation equipment, two families trapped", "q1", 0.91),
        ("sighting", "en", "Civil defense team on site, requesting backup", "q2", 0.87),
        ("question", "en", "How many people are missing?", "q0", 0.50),
        ("sighting", "en", "Pulled two children out, continuing rescue", "q0", 0.88),
        ("ack", "en", "Hospital alerted, sending ambulances", "q3", 0.85),
        ("noise", "en", "Praying for them", "q4", 0.20),
        ("sighting", "en", "Civil engineer on site, south wall unstable, need evacuation", "q1", 0.92),
    ],
    "SYR_DAMASCUS": [
        ("question", "en", "When will the water be back?", "t0", 0.40),
        ("question", "en", "Are there water tankers distributing nearby?", "t1", 0.42),
        ("ack", "en", "Municipality told us they are working on repairs", "t2", 0.55),
        ("sighting", "en", "Tanker arrived in the neighborhood but only enough for 20 homes", "t1", 0.68),
    ],
    "YEM_SANAA": [
        ("sighting", "en", "Young girl in a blue hijab crying near Bab al-Yemen", "w0", 0.84),
        ("sighting", "en", "Saw her with a woman I do not know, they headed west", "w1", 0.79),
        ("sighting", "en", "Found a child matching the description near the spice market", "w2", 0.86),
        ("question", "en", "What is the girl's exact age?", "w0", 0.40),
        ("ack", "en", "Told my family to search the market", "w1", 0.55),
        ("sighting", "en", "The girl is now at the spice shop, owner is feeding her", "w2", 0.93),
        # Fuel shortage
        ("ack", "en", "We have an extra fuel barrel, delivering now", "w3", 0.82),
    ],
    "LBN_BEIRUT": [
        ("sighting", "en", "Elderly man sitting on Hamra sidewalk, looks lost", "j0", 0.71),
        ("sighting", "en", "Elderly gentleman near AUB gate asking for directions", "j1", 0.78),
        ("question", "en", "Should I bring him water and a chair?", "j0", 0.50),
        ("ack", "en", "Hamra pharmacy notified, they will keep watch", "j1", 0.55),
    ],
}
