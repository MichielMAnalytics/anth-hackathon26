...
enum NoisePayloadType: UInt8 {
    ...
    case dtnBundle  = 0x25          // Opaque bundle gossipped peer-to-peer toward hub
    ...
    var description: String {
        ...
        case .dtnBundle: return "dtnBundle"
        case .dtnReceipt: return "dtnReceipt"
        case .dtnSummary: return "dtnSummary"
        }
    }
}
